    ...
    <div>
      ...
      {hasPassword && (
        <p>
          ...
          set correctly when you attempt to sync or change some data. If the
      ...
      {!hasPassword && (
        <p>
          ...
          will know if it is set correctly when you attempt to sync or change
          some data. If the password is incorrect, a security error message will
          be displayed and you will then have an opportunity to try again.
        </p>
      )}
